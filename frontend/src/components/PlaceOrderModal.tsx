                ...
                <div className="p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full border border-slate-200 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-700 outline-none focus:border-emerald-500 bg-slate-50"
                        >
                            {customers.map(c => (
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <textarea
                                ...
                                className="w-full border border-slate-200 rounded-xl p-3 pr-12 text-sm text-slate-700 outline-none focus:border-emerald-500 resize-none bg-slate-50 leading-relaxed"
                            />
                            {/* Voice button */}
                            <button

  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="prose prose-slate max-w-none">
        ...
        <h2 className="text-2xl font-bold text-slate-800 mt-8 mb-4">What Information We Collect</h2>
        
        <p className="font-semibold text-slate-700 text-sm mb-2">Information you give us:</p>
        ...
        <p className="font-semibold text-slate-700 text-sm mb-2">Information collected automatically:</p>
        <ul className="list-disc pl-5 text-slate-600 text-sm mb-4 space-y-1">
        ...
        <h2 className="text-2xl font-bold text-slate-800 mt-8 mb-4">Your Retailers' Data</h2>
        <p className="text-slate-600 text-sm leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-bold text-slate-800 mt-8 mb-4">Third-Party Services We Use</h2>
        <div className="overflow-x-auto my-6">
          <table className="w-full border-collapse border border-slate-200 text-sm text-left">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200">
                <th className="border border-slate-200 p-2.5 font-semibold text-slate-700">Service</th>
                <th className="border border-slate-200 p-2.5 font-semibold text-slate-700">Purpose</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-slate-200">
                <td className="border border-slate-200 p-2.5 text-slate-600 font-medium">Google Firebase</td>
                <td className="border border-slate-200 p-2.5 text-slate-600">Authentication (OTP login)</td>
              </tr>
              <tr className="border-b border-slate-200">
                <td className="border border-slate-200 p-2.5 text-slate-600 font-medium">Razorpay</td>
                <td className="border border-slate-200 p-2.5 text-slate-600">Payment link generation</td>
              </tr>
              <tr className="border-b border-slate-200">
                <td className="border border-slate-200 p-2.5 text-slate-600 font-medium">Google Gemini AI</td>
                <td className="border border-slate-200 p-2.5 text-slate-600">Order parsing from WhatsApp messages</td>
              </tr>
              <tr className="border-b border-slate-200">
                <td className="border border-slate-200 p-2.5 text-slate-600 font-medium">Evolution API</td>
                <td className="border border-slate-200 p-2.5 text-slate-600">WhatsApp connectivity</td>
              </tr>
              <tr className="border-b border-slate-200">
                <td className="border border-slate-200 p-2.5 text-slate-600 font-medium">Google Analytics</td>
                <td className="border border-slate-200 p-2.5 text-slate-600">Usage analytics</td>
              </tr>
              <tr className="border-b border-slate-200">
                <td className="border border-slate-200 p-2.5 text-slate-600 font-medium">Microsoft Clarity</td>
                <td className="border border-slate-200 p-2.5 text-slate-600">User behaviour analytics</td>
              </tr>
              <tr className="border-b border-slate-200">
                <td className="border border-slate-200 p-2.5 text-slate-600 font-medium">Neon (PostgreSQL)</td>
                <td className="border border-slate-200 p-2.5 text-slate-600">Data storage</td>
              </tr>
              <tr className="border-b border-slate-200">
                <td className="border border-slate-200 p-2.5 text-slate-600 font-medium">Render</td>
                <td className="border border-slate-200 p-2.5 text-slate-600">Cloud hosting</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <h2 className="text-2xl font-bold text-slate-800 mt-8 mb-4">Data Storage and Security</h2>
        <ul className="list-disc pl-5 text-slate-600 text-sm mb-4 space-y-1">
        ...
        <h2 className="text-2xl font-bold text-slate-800 mt-8 mb-4">Data Retention</h2>
        <ul className="list-disc pl-5 text-slate-600 text-sm mb-4 space-y-1">
        ...
        <h2 className="text-2xl font-bold text-slate-800 mt-8 mb-4">Your Rights</h2>
        <p className="text-slate-600 text-sm leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-bold text-slate-800 mt-8 mb-4">Changes to This Policy</h2>
        <p className="text-slate-600 text-sm leading-relaxed mb-4">

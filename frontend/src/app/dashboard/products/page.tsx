      ...
      <div className="flex-1 pl-64 flex flex-col h-screen overflow-hidden">
        ...
        <main className="flex-1 mt-16 p-6 overflow-y-auto space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-dashboard-card p-6 rounded-xl border border-dashboard-border shadow-sm flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-xl">✍️</span>
                  <h3 className="font-semibold text-slate-800 dark:text-slate-100 text-lg">Add Product Manually</h3>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full p-2 border border-slate-200 dark:border-white/10 rounded-lg text-sm text-slate-700 dark:text-slate-300 focus:outline-none focus:ring-1 focus:ring-brand-blue bg-white dark:bg-dashboard-card"
                      />
                    </div>
          ...
          <div className="bg-white dark:bg-dashboard-card rounded-xl border border-dashboard-border shadow-sm flex flex-col min-h-[400px]">
            ...
            <div className="p-5 border-b border-dashboard-border flex items-center justify-between bg-slate-50/50 dark:bg-dashboard-inset rounded-t-xl gap-4">
              ...
              <div className="text-xs font-bold text-slate-400">
                Total Listed SKUs: <span className="text-slate-700 dark:text-slate-300">{filteredProducts.length}</span>
              </div>
            </div>

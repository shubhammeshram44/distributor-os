  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="prose prose-slate max-w-none">
        <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">Agreement</h2>
        ...
        <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">What DistributorOS Does</h2>
        <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">Your Account</h2>
        <p className="font-semibold text-slate-700 dark:text-slate-300 text-sm mb-2">You are responsible for:</p>
        <ul className="list-disc pl-5 text-slate-600 dark:text-slate-400 text-sm mb-4 space-y-1">
        ...
        <p className="font-semibold text-slate-700 dark:text-slate-300 text-sm mb-2">You must not:</p>
        <ul className="list-disc pl-5 text-slate-600 dark:text-slate-400 text-sm mb-4 space-y-1">
        ...
        <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">WhatsApp Usage</h2>
        <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">Payments</h2>
        <p className="font-semibold text-slate-700 dark:text-slate-300 text-sm mb-2">Subscription fees:</p>
        <ul className="list-disc pl-5 text-slate-600 dark:text-slate-400 text-sm mb-4 space-y-1">
        ...
        <p className="font-semibold text-slate-700 dark:text-slate-300 text-sm mb-2">Razorpay integration:</p>
        <ul className="list-disc pl-5 text-slate-600 dark:text-slate-400 text-sm mb-4 space-y-1">
        ...
        <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">Uptime and Reliability</h2>
        <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4">
        ...
        <p className="font-semibold text-slate-700 dark:text-slate-300 text-sm mb-2">We are not liable for:</p>
        <ul className="list-disc pl-5 text-slate-600 dark:text-slate-400 text-sm mb-4 space-y-1">
        ...
        <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">Limitation of Liability</h2>
        <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">Governing Law</h2>
        <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">Changes to These Terms</h2>
        <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4">
        ...
        <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mt-8 mb-4">Contact</h2>
        <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4">
